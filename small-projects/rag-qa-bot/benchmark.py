"""Performance benchmark for rag-qa-bot."""
...
def measure_request_latency(n=100):
    ...
    for _ in range(n):
        start = time.perf_counter()
        # Simulate: embed query + vector search + generation
        _ = [i * i for i in range(1000)]  # placeholder work
...
def main():
    print("=" * 50)
    print("  RAG-QA-BOT Performance Benchmark")
    print("=" * 50)
